...
_IC001_PROBLEM = {
    ...
    "enunciat": (
        "**Context.** Has fet una recerca per estimar **quantes hores "
        "al dia estudien els estudiants de primer curs durant "
        "l'època d'exàmens**. La població d'interès són els ~250 "
        "estudiants de primer de la teva facultat. Has pres una "
        "mostra aleatòria de **n = 44 estudiants** i has obtingut "
        "una mitjana mostral de **x̄ = 4,0 hores/dia**, amb una "
        "desviació estàndard estimada de **σ ≈ 2,7 hores**.\n\n"
        "**El càlcul.** Aplicant la fórmula del marge d'error al "
        "95% de confiança, amb z* = 1,96 (el valor crític de la "
        "normal estàndard per al 95%):\n\n"
        "E = z* · σ/√n = 1,96 · 2,7/√44 ≈ **0,80 hores**\n\n"
        "L'interval de confiança resultant per a la mitjana μ "
        "d'hores d'estudi diari és:\n\n"
    ...
    "passos": [
        {
            ...
            "text": (
                ...
                "Sobre la nostra estimació mostral (x̄ = 4,0)? "
                "Sobre l'interval [3,2 ; 4,8] que hem construït?"
            ),
            "expected_summary": (
        ...
        },
        {
            "id": 2,
            "text": (
                "Imagina que un company et diu: «la probabilitat que la "
                "mitjana real d'hores d'estudi μ estigui entre 3,2 i 4,8 "
                "hores és del 95%». **Per què aquesta frase és "
                "incorrecta?**"
            ),
            "expected_summary": (
        ...
        },
        {
            ...
            "text": (
                ...
                "de l'interval [3,2 ; 4,8] hores/dia per a la mitjana "
                "μ d'hores d'estudi diari dels estudiants de primer."
            ),
            "expected_summary": (
...
_CAUS001_PROBLEM = {
    ...
    "enunciat": (
        "Segons l'**Anuari 2024 de la Fundació Bofill** (a partir de "
        "dades de l'**Idescat** i del Ministeri d'Educació, EPA 2023), "
        "a Catalunya la **taxa d'abandonament escolar prematur (AEP)** "
        "entre joves de 18 a 24 anys és d'un **36,1%** entre joves "
        "d'origen estranger i d'un **10,6%** entre joves de nacionalitat "
        "espanyola. La taxa és més de tres vegades superior entre "
        "l'alumnat d'origen migrat: un **gap de 25,5 punts**. Anem a "
        "interpretar aquesta diferència pas a pas, amb dades reals i "
        "càlculs."
    ),
    ...
    "passos": [
        {
            "id": 1,
            "text": (
                "Comencem verificant que la diferència és **real i "
                "aritmèticament consistent**, no un artefacte estadístic. "
                "Aquestes són les dades publicades (Bofill / Idescat, "
                "2023):\n\n"
                "- AEP **global** a Catalunya (18-24 anys): **14,0%**\n"
                "- **% d'alumnes** de secundària de nacionalitat "
                "estrangera: **12,6%**\n"
                "- AEP entre joves d'origen estranger: **36,1%**\n\n"
                "**Calcula amb una mitjana ponderada la taxa d'AEP que "
                "esperaríem per als joves de nacionalitat espanyola.** "
                "Compara-la amb el 10,6% que reporta la mateixa font. "
                "Què en treus: la diferència és real, és un artefacte "
                "estadístic, o no podem dir-ho? I aquesta consistència "
                "aritmètica, ens diu res sobre si l'origen és la **causa** "
                "del gap?"
            ),
            "expected_summary": (
        ...
        },
        {
            "id": 2,
            "text": (
                "Sabem ara que el gap (25,5 punts) és aritmèticament "
                "real, però no si és causa o associació espúria. Per "
                "discriminar, busquem **variables confusores** que "
                "puguin explicar el gap sense que l'origen hi tingui "
                "cap paper causal propi.\n\n"
                "Atenció a una trampa freqüent: **NO totes les "
                "variables que prediuen l'AEP són confusores** "
                "d'origen→AEP. Per ser-ho cal complir DOS criteris "
                "alhora:\n"
                "(a) Correlacionar amb l'AEP (prediu-la)\n"
                "(b) Distribuir-se de manera diferent entre joves "
                "d'origen migrat i nadius\n\n"
                "Et passo TRES variables amb dades reals publicades. "
                "**Per a cadascuna, fes una mitjana ponderada per "
                "calcular quants punts del gap (25,5) explicaria si fos "
                "l'únic mecanisme**, i classifica-la com a confusora "
                "forta, moderada o no-confusora.\n\n"
                "**Variable 1 — Renda familiar** (Bofill 2024 / PISA "
                "2022):\n"
                "- AEP entre joves de renda baixa: **19,4%**\n"
                "- AEP entre joves de renda alta: **1,9%**\n"
                "- % d'alumnat d'origen migrat amb nivell socioeconòmic "
                "baix: **52,7%**\n"
                "- % d'alumnat autòcton amb nivell socioeconòmic baix: "
                "**13,4%**\n\n"
                "**Variable 2 — Sexe** (Bofill 2024 / Idescat 2024):\n"
                "- AEP entre nois: **15,8%**\n"
                "- AEP entre noies: **12,0%**\n"
                "- % d'homes entre població de nacionalitat estrangera: "
                "**51,7%**\n"
                "- % d'homes entre població de nacionalitat espanyola: "
                "**48,7%**\n\n"
                "**Variable 3 — Escolarització en centres d'alta "
                "complexitat / segregació escolar** (Zancajo & Bueno "
                "per a Bofill, 2024):\n"
                "- Taxa d'abandonament en centres d'alta complexitat: "
                "**11,8%**\n"
                "- Taxa d'abandonament en la resta de centres: **5,4%**\n"
                "- % d'alumnat estranger en centres d'alta complexitat: "
                "**~28%**\n"
                "- % d'alumnat autòcton en centres d'alta complexitat: "
                "**~4%**\n"
            ),
            "expected_summary": (
        ...
        },
        {
            "id": 3,
            "text": (
                "Per acabar, l'estudi quasi-experimental del **Centre "
                "d'Estudis Demogràfics** publica aquestes taxes de "
                "no-graduació a l'ESO entre fills d'estrangers, segons "
                "l'edat d'arribada a Catalunya:\n\n"
                "- Nascuts a Catalunya (de pares estrangers): **21,2%**\n"
                "- Arribats abans dels 7 anys: **21,7%**\n"
                "- Comparació: joves de nacionalitat espanyola tenen "
                "AEP de **10,6%**\n\n"
                "Tres preguntes per respondre amb aquestes dades:\n"
                "1. Si **l'origen migrat fos la causa directa** de "
                ...
                "3. Per què **tots dos números** (21,2% i 21,7%) són "
                "tan per sobre del 10,6% dels joves de nacionalitat "
                "espanyola, malgrat tenir tota o gairebé tota la "
                "trajectòria escolar feta aquí?\n\n"
                "Què en treus, en lectura causal global?"
            ),
            "expected_summary": (
